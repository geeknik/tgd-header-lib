...
TEST_CASE("Encode and decode layer") {
    ...
    layer.set_compression_type(tgd_header::layer_compression_type::uncompressed);
    ...
    REQUIRE(new_layer.compression_type() == tgd_header::layer_compression_type::uncompressed);
